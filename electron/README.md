# Code Monkey Electron Desktop App

This directory contains the Electron wrapper for Code Monkey, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Code Monkey/data/`
  - Windows: `%APPDATA%/Code Monkey/data/`
  - Linux: `~/.config/Code Monkey/data/`
